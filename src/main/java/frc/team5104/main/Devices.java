...
public class Devices {
	...
	public static class Drive {
		public static TalonSRX L1 = TalonFactory.getTalon(11,
				new TalonSettings(NeutralMode.Brake, true, _DriveConstants._currentLimit, true));
		public static TalonSRX L2 = TalonFactory.getTalon(12,
				new TalonSettings(NeutralMode.Brake, true, _DriveConstants._currentLimit, true));
		public static TalonSRX R1 = TalonFactory.getTalon(13,
				new TalonSettings(NeutralMode.Brake, false, _DriveConstants._currentLimit, true));
	...
	public static class Cargo {
		public static TalonSRX leftArm = TalonFactory.getTalon(21,
				new TalonSettings(NeutralMode.Brake, true, _ArmConstants._currentLimit, true));
		public static TalonSRX rightArm = TalonFactory.getTalon(22,
				new TalonSettings(NeutralMode.Brake, false, _ArmConstants._currentLimit, true));
	...
	public static class Hatch {
		public static DoubleSolenoid flaps = PneumaticFactory.getDoubleSolenoid(PCM.Red,
				_RobotConstants._isCompBot ? 1 : 2, _RobotConstants._isCompBot ? 0 : 3);
