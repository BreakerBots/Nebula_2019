...
public class _AutoConstants {
	...
	public static final double _maxVelocity = 16.25;//16.455; 			  //(Feet) [Tune] in ft/s
	public static final double _maxAcceleration = 21.0;//21.442; 		  //(Feet) [Tune] in ft/s/s
	public static final double _maxJerk = 0.25;//0.297; 				  //(Feet) [Tune] in ft/s/s/s
