...
public class _AutoConstants {
	...
	public static final double _maxJerk = 15;//0.297; 				  //(Feet) [Tune] in ft/s/s/s
	...
	//Trajectory Folowing
	public static final double _tfB    = 0.3; //(None) [Tune/Choose] (Range: Great Than Zero) Increases/Decreases Correction
